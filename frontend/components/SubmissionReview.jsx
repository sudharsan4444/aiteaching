    ...
    const handleDownloadPDF = (sub) => {
        ...
        const questionsHTML = assessment.questions.map((q, i) => {
            ...
            <tr style="border-bottom:1px solid #e2e8f0">
                ...
                <td style="padding:8px;font-size:12px;text-align:center">${fb.pointsAwarded ?? '—'}/${q.maxPoints || (q.type === 'MCQ' ? 5 : 10)}</td>
                                    ...
                                    <div className="border-t border-slate-100 p-5 bg-slate-50">
                                        ...
                                        <div className="space-y-3">
                                            {assessment.questions.map((q, i) => {
                                                ...
                                                return (
                                                    <div key={i} className={`bg-white border rounded-xl p-4 ${isCorrect === true ? 'border-emerald-200' : isCorrect === false ? 'border-red-200' : 'border-slate-100'}`}>
                                                        <div className="flex items-start justify-between gap-3">
                                                            <div className="flex-1">
                                                                ...
                                                                <p className="text-xs text-slate-500">
                                                                    <span className="font-bold">Student:</span> {typeof displayAns === 'string' ? displayAns : JSON.stringify(displayAns)}
                                                                </p>
                                                                {fb.feedback && (
